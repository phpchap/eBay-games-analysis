...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@top_game') ?>

    <div class="sf_admin_actions_block ui-widget">
      <?php include_partial('top_game/form_actions', array('top_game' => $top_game, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
    </div>
